...
public:
    inline Frustum(const Fxp &verticalFov, const Fxp &ratio, const Fxp &nearDistance, const Fxp &farDistance)
    {
    ...
    inline void Update(const Fxp3D &position, const Fxp3D &xAxis, const Fxp3D &yAxis, const Fxp3D &zAxis)
    {
    ...
    inline bool PointInFrustum(const Fxp3D &position) const
    {
    ...
    inline bool SphereInFrustum(const Fxp3D &position, const Fxp &size) const
    {
    ...
    inline Fxp3D GetVertex(const Fxp3D &position, const Fxp &size, const Fxp3D &normal, bool getPositiveVector) const
    {
    ...
    inline bool BoxInFrustum(const Fxp3D &position, const Fxp &size) const
    {
        Fxp3D vertexN;
        for (size_t i = 0; i < Plane::Count; i++)
        {
