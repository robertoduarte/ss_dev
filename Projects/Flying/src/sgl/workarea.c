...
#define  MAX_POLYGONS  1500 /* number of vertices that can be used */
#define  MAX_EVENTS  10 /* number of events that can be used   */
#define  MAX_WORKS  10 /* number of works that can be used    */
...
#define  AdjWork(pointer,size,count) (pointer + (size) * (count))
