...
extern void LstInitList(List* list);
extern void LstAddNodeToHead(List* list, Node* n);
extern void LstAddNodeToTail(List* list, Node* n);
extern void LstAddNodeBefore(List* list, Node* n, Node* cur);
extern void LstAddNodeAfter(List* list, Node* n, Node* cur);
extern void LstAddNodeByKey(List* list, Node* n);
extern void LstUnlinkNode(List* list, Node* n);
extern Node* LstFindNodeByKey(List* list, long key);
extern void LstIterate(List* list, int (*callback)(Node* n));
extern void LstIterateValue(List* list, int (*callback)(Node* n, dword v1, dword* v2), dword val1, dword* val2);
extern void LstChangeKey(List* list, Node* n, long key);
