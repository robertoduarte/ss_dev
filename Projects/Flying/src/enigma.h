...
enum
{
    ASYNC_MESS_NULL = 0x00000000,
    ASYNC_MESS_CREATE = 0x00000001,
    ASYNC_MESS_DESTROY = 0x00000002,
    ASYNC_MESS_SET_RUNSTATE = 0x00000004,
    ASYNC_MESS_RS_RUN = 0x00000004,
    ASYNC_MESS_RS_WAIT = 0x00000005,
    ASYNC_MESS_RS_SLEEP = 0x00000006,
    ASYNC_MESS_RS_SUSPEND = 0x00000007,

    ASYNC_MESS_PRIORITY_1 = 0x000000FF, // above this, all actors receive

    ASYNC_MESS_COLLIDE_ATT = 0x00000100,
    ASYNC_MESS_COLLIDE_DEF = 0x00000101,

    ASYNC_MESS_PRIORITY_2 = 0x0000FFFF, // above this, unsuspended actors
    // below this, running/waiting actors

    ASYNC_MESS_PRIVATE = 0x01000000, // private message range
    ASYNC_MESS_ENDPRIVATE = 0x01FFFFFF,
    ASYNC_MESS_BROADCAST = 0x80000000,
